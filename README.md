...
| TC002     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x                                        | 〃                                                                             | Pass (after debugging)    ||      | All links route correctly; “Skills” deep link works;“Contact” scrolls to footer on every page.Navbar collapses/expands correctly at mobile widths.Keyboard navigation traverses items with visible focus.No broken links reported by W3C Link Checker.|
| TC003     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | CV download (PDF) opens; filename correct |
| TC004     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             |    |Partial|      | External links open in new tab; rel attributes present |Open in separate tab: Verified this is working as expected.
No broken links: No evidence of broken URLs.
Security attributes (target + rel): Target confirmed in code but not rel.
Keyboard & SR-friendly: Meets expectations (descriptive labels; standard anchors).
External social links are present site-wide and point to specific profile URLs.
Accessibility of link text is good.
| TC005     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             |    |  Partial       |      | Footer links & social icons |Internal links — N/A.
External links are well-formed and have been confirmed for target="_blank" + rel="noopener noreferrer".
Visual/keyboard focus — Works as expected.
Screen reader announcement — Text links fine, but icon-only social links need ARIA labels.
Broken/incorrect links — None found.
...
| TC006     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             |    |  Partial       |      | Homepage carousel controls, indicators, focus visible |Pass: Internal links, consistent footer, hover/keyboard feedback.
Needs improvement: Fails auto-start (not required) and alt text quality; minor ARIA mismatch.
Suggestions
Note: If needed, enable sensible auto-play (and pause on hover/focus).
Fix ARIA on the control buttons.
...
| TC008     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             |    |Partial     |      | Content accuracy & copy review (all pages) |Pass: Professional tone,Correct use of UK spelling,Dates/qualifications read clearly & Pages render clearly
Needs improvement: Typos, Capitalisation inconsistencies, Icon labels casing & Sentence tightning.
Suggestions
In work-experience.html: Correct title tag with Work Experience & Skills | Roberto Pires.
In work-experience.html: Change “A-Level” → “A-level” in body text.
...
| TC009     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Link text/aria-labels descriptive |
| TC010     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Buttons: hover/focus/disabled styles consistent |
| TC011     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             |    | Partial        |      | Font readability (clamp sizes, contrast) |Partial Fail: small text in some components and sub-4.5:1 contrast on button texte
Needs improvment: Raise minimum text sizes & line-height, Fix button text contrast, Keep focus & readability cues
Suggestions
Raise minimum text sizes & line-height.
Fix button text contrast (≥4.5:1).
Keep focus & readability cues.
| TC012     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Visual hierarchy & spacing |
| TC013     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Paragraph spacing/line-height |
| TC014     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Button visibility/affordance |
| TC015     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | **Desktop 1920×1080** responsive layout check |
| TC016     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | **Tablet 768×1024** (iPad emulation/physical) |
| TC017     | Chrome (Android), Safari (iOS)       | Chrome 126+ · Safari iOS 17              | Pixel / iPhone                                                                | Pass  |         |      | **Mobile portrait** (Pixel 7 / iPhone 14) |
| TC018     | Chrome (Android), Safari (iOS)       | 〃                                        | Pixel / iPhone                                                                | Pass   |         |      | **Mobile landscape** spot checks |
| TC019     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Keyboard navigation (Tab/Shift+Tab/Enter) |
| TC020     | Safari (macOS/iOS), Chrome, Edge     | 〃                                        | 〃                                                                             | Pass   |         |      | Screen reader basics (VoiceOver/NVDA quick pass) |
| TC021     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Semantic HTML (landmarks, heading order) |
| TC022     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Alt text: informative vs decorative (icons alt="") |
| TC023     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | ARIA use (carousel, live regions if any) |
| TC024     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             |    |         |  Fail    | “Skip to content” works; anchor offset OK |No visible “Skip to content” link appears as the first focusable element on page load on the reviewed pages. I also don’t see markup for a skip link targeting
Suggestions
Fix (minimal, accessible pattern).
| TC025     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | (Use this for any performance or extra feature test) |
| TC026     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Images optimised (WebP / sizes) |
| TC027     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | HTML/CSS validation (W3C) — no critical errors |
| TC028     | Chrome, Edge, Firefox, Safari        | 〃                                        | 〃                                                                             | Pass   |         |      | Regression sweep after updates — no breaks |
