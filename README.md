...
- [x] Skills are grouped into logical categories (e.g. Teaching, Coding, Networking, IT Support, Graphic Design).  
- [x] Each skill has a short, clear description.  
- [x] Visual layout is consistent with site design (e.g. tiles, icons, badges).  
- [x] Links to supporting pages (e.g. Certifications, Work Experience) are included.  
- [x] Navigation is easy to use for non-technical users.
- [x] The site is responsive across desktop, tablet, and mobile.

**Tasks**

- [x] Categorise skills and write short descriptions for each.  
- [x] Design tile-based or grid layout with icons and responsive behaviour.  
- [x] Link technical skills to Projects page and teaching skills to Work Experience.  
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
- [x] Test across desktop, tablet, and mobile.  
...
- [x] Subject areas are clearly listed with the relevant levels (KS3, GCSE, A-Level).  
- [x] Teaching experience and approach are mentioned briefly.  
- [x] Key qualifications are highlighted or linked to the Certifications page.  
- [x] A link to Bookings or Contact page is visible.  
- [x] The site is responsive across desktop, tablet, and mobile.
- [x] There is an intuitive navigation menu linking to all main pages.

**Tasks**

- [x] Write brief, accessible descriptions for CS and Maths.  
- [x] Include call-to-action: "Book a Tutoring Session" or "Enquire Now".  
- [x] Highlight PGCE, CPD or relevant CPD courses with a link.  
- [x] Ensure menu links to other pages.
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
- [x] Test across desktop, tablet, and mobile.  
...
- [x] Lists teaching competencies with clear examples.  
- [x] Shows CPD engagement and adaptability.  
- [x] Link to Work Experience and Certifications provided.  
- [x] Layout is formal and easy to scan.
- [x] Menu Links to other pages are easily accessible.
- [x] Option to download/view CV is visible.
- [x] The site is responsive across desktop, tablet, and mobile.

**Tasks**

- [x] Write tiles for each skill.  
- [x] Add link: "Work Experience" or "Download CV (PDF)".  
- [x] Style using a clean and professional format.  
- [x] Include a CV download button or link.
- [x] Feature quick-access menu links to other pages.
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
...
- [x] IT and web development skills are grouped (e.g. "Coding", "Web Development", "Networking", "Support").  
- [x] Relevant technologies and tools are listed (e.g. Python, HTML, Cisco, CompTIA).  
- [x] Mentions of qualifications (A+, CCNA, etc.) and current Level 5 Diploma Website Development.  
- [x] Menu Links to other pages are provided e.g. Work Experience and Certifications pages .  
- [x] Navigation and layout are mobile/tablet-friendly and accessible.

**Tasks**

- [x] List each technical skill with tool/language (e.g. "Python – scripting and basic web apps").  
- [x] Organise into clear groups: Programming, Networking, Web Dev, Systems Support.  
- [x] Include short paragraph about ongoing Code Institute Level 5 training.  
- [x] Menu link to other pages e.g. Work Experience and Certifications pages.  
- [x] Use icons or badges for modern, visual appeal. 
- [x] Ensure skills loads quickly and looks clean on all devices.
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
...
- [x] Displays all relevant qualifications with name, and awarding body.  
- [x] Groups certifications by category (e.g. Teaching, IT, Design, Software Development).  
- [x] Includes visual elements like icons or logos where appropriate.  
- [x] Responsive design works across desktop, tablet, and mobile.  
- [x] Links to download CV or view Work Experience and Skills.  
- [x] There is an intuitive navigation menu linking to all main pages.

**Tasks**

- [x] List certifications in organised manner (e.g. PGCE, CompTIA A+, CCNA, CPD Graphic Design).  
- [x] Write clear descriptions for each.  
- [x] Design tile or card layout with logos/icons.  
- [x] Add menu links to other pages e.g. CV, Work Experience, and Skills pages.  
- [x] Ensure accessibility (alt text, keyboard navigation).  
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
- [x] Style certification page with a clean, professional layout.
...
- [x] Teaching qualifications (e.g. PGCE, CPD) are easy to find and explained simply.  
- [x] No technical jargon — use parent-friendly language.  
- [x] Highlights subject-specific credentials (e.g. Computer Science).  
- [x] A link to the Bookings page.
- [x] Navigation is easy to use for non-technical users.
- [x] The site is responsive across desktop, tablet, and mobile.

**Tasks**

- [x] Provide short description of PGCE and CPD training in plain English.  
- [x] Emphasise Maths and CS relevance.  
- [x] Include a button or link: “Bookings”.  
- [x] Ensure menu links to other pages.
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
...
- [x] Clearly lists PGCE, subject degree, and CPD.  
- [x] Includes awarding institutions.   
- [x] Offers link to downloadable CV or Work Experience.  
- [x] Menu links to other pages are easily accessible.
- [x] The layout reflects professionalism and clarity.
- [x] The site is responsive across desktop, tablet, and mobile.
...
- [x] Add tile format or structured grid layout for formal credentials.  
- [x] Label each entry: "Qualification – Institution".  
- [x] Include section for CPD.  
- [x] Add link: "Download CV" or "Explore Teaching Experience".  
- [x] Feature quick-access menu links to other pages.
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
...
- [x] Shows relevant IT and networking certifications (A+, CCNA, ITF+).  
- [x] Mentions current full-stack training and web dev focus.  
- [x] Includes skills related to support, networks, coding.  
- [x] Provides menu links to other pages e.g. Projects and Skills pages. 
- [x] Navigation and layout are mobile/tablet-friendly and accessible.
- [x] The site is responsive across desktop, tablet, and mobile.

**Tasks**

- [x] Use IT-related logos/icons (e.g. CompTIA, Cisco, Code Institute).  
- [x] Write short, informative content for each certification.  
- [x] Add internal menu links to other pages e.g. Skills, Projects.  
- [x] Ensure certifications page loads quickly and looks clean on all devices.
- [x] Place technical content where it's easy to notice but not overwhelming.
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
...
- [x] Includes a contact/booking form with fields for name, telephone, email, service and message.  
- [x] Form is responsive across all devices.  
- [x] A confirmation message appears upon successful submission.  
- [x] Clear summary of available services is shown above the form.  
- [x] Menu links to all relevant pages e.g. Skills, and Projects.  
- [x] The site is responsive across desktop, tablet, and mobile.
- [x] There is an intuitive navigation menu linking to all main pages.

**Tasks**

- [x] Design and build a booking form using HTML and CSS (or form integration tool).  
- [x] Add validation for required fields.  
- [x] Write short service descriptions (e.g. "Tutoring", "Web Development").  
- [x] Set up form submission.  
- [x] Add confirmation message or redirect.  
- [x] Style layout to be clean, professional, and accessible.  
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
- [x] Menu links to key sections to other pages.
- [x] Style bookings page with a clean, professional layout.
...
- [x] Clearly lists subjects and levels offered (e.g. KS3, GCSE, A-Level).  
- [x] Form includes service selection and optional message area.  
- [x] Language is accessible and welcoming.  
- [x] Menu links to other pages are visible.  
- [x] Navigation is easy to use for non-technical users.
- [x] The site is responsive across desktop, tablet, and mobile.

**Tasks**

- [x] Write a short section explaining tutoring services.  
- [x] Add form field for selecting service.  
- [x] Style form for simplicity and accessibility.  
- [x] Ensure menu links to other pages.
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
...
- [x] Mentions availability for part-time/contract roles, online sessions, or curriculum consultation.  
- [x] Includes a message field to outline request details.  
- [x] CV download and links to Work Experience and Certifications are clearly accessible.  
...
- [x] Add brief section: "Available for part-time, full-time teaching or tutoring."  
- [x] Include links: "Download CV" and "Work Experience".  
- [x] Test for form reliability and professional tone.  
- [x] Feature quick-access menu links to other pages.
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
...
- [x] Lists services like consulting or workshops.  
- [x] Option to specify the type of service needed in a message box.  
- [x] Includes links to technical Skills and certifications.  
- [x] Professional and concise layout.  
- [x] Provides menu links to other pages e.g. Certifications and Skills pages.
- [x] Navigation and layout are mobile/tablet-friendly and accessible.
- [x] The site is responsive across desktop, tablet, and mobile.

**Tasks**

- [x] Include form field for "Type of Service Requested".  
- [x] Add internal links: "Skills" / "Certifications".  
- [x] Ensure layout works well on mobile and desktop.  
- [x] Add internal menu links to other pages e.g. Skills, Certifications.
- [x] Ensure bookings page loads quickly and looks clean on all devices.
- [x] Implement responsive navigation using HTML/CSS or Bootstrap.
...
- [x] A download button or link is visible on key pages (e.g. Homepage, About Me, Work Experience).
- [x] The CV is provided in PDF format.
- [x] The file is professionally formatted and up to date.
- [x] The link is accessible and clearly labelled (e.g. “Download CV (PDF)”).
- [x] The download link works on all devices and browsers.

**Tasks**

- [x] Create and format the latest CV as a PDF.
- [x] Upload the PDF to the web server or GitHub repository.
- [x] Add download buttons/links to relevant pages.
- [x] Test download functionality across desktop and mobile.
- [x] Ensure accessibility with descriptive alt text or ARIA labels.
...
- [x] CV is easily accessible from relevant pages.
- [x] CV includes relevant teaching qualifications, subjects taught, and experience.
- [x] The document is clearly labelled and downloadable in one click.
- [x] The download link works on all devices and browsers.

**Tasks**

- [x] Include CV link next to or within the About Me or Bookings section.
- [x] Ensure file name is clear and readable (e.g. 'Rob_Pires_Tutor_CV.pdf').
- [x] Test download functionality across desktop and mobile.
- [x] Ensure accessibility with descriptive alt text or ARIA labels.
...
- [x] Downloadable CV includes professional history, subject specialisms, and qualifications.
- [x] Clear link/button to download CV from relevant pages e.g. homepage or Work Experience page.
- [x] File is accessible and opens without issue.
- [x] The document is clearly labelled and downloadable in one click.
- [x] The download link works on all devices and browsers.

**Tasks**

- [x] Ensure CV includes full qualifications (e.g. PGCE, CPD) and experience timeline.
- [x] Label link professionally (e.g. "Download CV (PDF)").
- [x] Test download functionality across desktop and mobile.
- [x] Ensure accessibility with descriptive alt text or ARIA labels.
...
- [x] CV highlights IT certifications and current web development training.
- [x] Link to CV is accessible on relevant pages e.g. homepage or Certifications/Skills pages.
- [x] The file provides an overview of relevant technical skills and experience.
- [x] The document is clearly labelled and downloadable in one click.
- [x] The download link works on all devices and browsers.

**Tasks**

- [x] Highlight IT qualifications (CompTIA A+, ITF+, CCNA, Code Institute Level 5) in CV.
- [x] Add download link to Skills or Projects section.
- [x] Test download functionality across desktop and mobile.
- [x] Ensure accessibility with descriptive alt text or ARIA labels.
...
|-----------|--------------------------------------|------------------------------------------|-------------------------------------------------------------------------------|:----:|:-------:|:----:|----------------------------|
| TC001     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x | Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max| Pass   |         |      | desktoplaptop/tablet/mobile: iPhone SE, iPad Air, Nest Hub & Nest Hub Max |
| TC002     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x                                        | Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                             |     |Partial|      | All links route correctly; “Skills” deep link works;“Contact” scrolls to footer on every page.Navbar collapses/expands correctly at mobile widths.Keyboard navigation traverses items with visible focus.No broken links reported by W3C Link Checker.|
| TC003     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x|Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                           | Pass   |         |      | CV download (PDF) opens; filename correct |
| TC004     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                           |    |Partial|      | External links open in new tab; rel attributes present |Open in separate tab: Verified this is working as expected.
No broken links: No evidence of broken URLs.
Security attributes (target + rel): Target confirmed in code but not rel.
Keyboard & SR-friendly: Meets expectations (descriptive labels; standard anchors).
External social links are present site-wide and point to specific profile URLs.
Accessibility of link text is good.
| TC005     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                         |    |  Partial       |      | Footer links & social icons |Internal links — N/A.
External links are well-formed and have been confirmed for target="_blank" + rel="noopener noreferrer".
Visual/keyboard focus — Works as expected.
Screen reader announcement — Text links fine, but icon-only social links need ARIA labels.
Broken/incorrect links — None found.
Hover feedback: Not a feature; site CSS removes underlines by default. For clear affordance, add an underline (or color shift with sufficient contrast) on :hover and :focus-visible in the footer.
Keyboard tabbing & focus: Footer links are standard elements - tabbable/activatable with Tab/Enter. Add/keep a strong visible focus indicator (site already uses :focus-visible elsewhere; extend it to footer links).
| TC006     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x|Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                           |    |  Partial       |      | Homepage carousel controls, indicators, focus visible |Pass: Internal links, consistent footer, hover/keyboard feedback.
Needs improvement: Fails auto-start (not required) and alt text quality; minor ARIA mismatch.
Suggestions
Note: If needed, enable sensible auto-play (and pause on hover/focus).
Fix ARIA on the control buttons.
...
Respect reduced motion.
(Optional) Allow touch swipes explicitly (Bootstrap default is true)
| TC007     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            |      |         |      | **N/A (no live chat widget on site)** |
| TC008     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                          |    |Partial     |      | Content accuracy & copy review (all pages) |Pass: Professional tone,Correct use of UK spelling,Dates/qualifications read clearly & Pages render clearly
Needs improvement: Typos, Capitalisation inconsistencies, Icon labels casing & Sentence tightning.
Suggestions
In work-experience.html: Correct title tag with Work Experience & Skills | Roberto Pires.
In work-experience.html: Change “A-Level” → “A-level” in body text.
In certifications.html (icon alt/labels): “BSC Hons CS icon” → “BSc Hons CS icon”; “CISCO CCNA icon” → “Cisco CCNA icon”.
Optional style tweak (Work Experience > Software/Website Developer section): “My programming background includes experience where I developed applications…” → “My programming background includes developing applications…”.
| TC009     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            | Pass   |         |      | Link text/aria-labels descriptive |
| TC010     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            | Pass   |         |      | Buttons: hover/focus/disabled styles consistent |
| TC011     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            |    | Partial        |      | Font readability (clamp sizes, contrast) |Partial Fail: small text in some components and sub-4.5:1 contrast on button texte
Needs improvment: Raise minimum text sizes & line-height, Fix button text contrast, Keep focus & readability cues
Suggestions
Raise minimum text sizes & line-height.
Fix button text contrast (≥4.5:1).
Keep focus & readability cues.
| TC012     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            | Pass   |         |      | Visual hierarchy & spacing |
| TC013     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x | Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            | Pass   |         |      | Paragraph spacing/line-height |
| TC014     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                             | Pass   |         |      | Button visibility/affordance |
| TC015     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            | Pass   |         |      | **Desktop 1920×1080** responsive layout check |
| TC016     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                             | Pass   |         |      | **Tablet 768×1024** (iPad emulation/physical) |
| TC017     | Chrome (Android), Safari (iOS)       | Chrome 139.0.7258.128 · Safari 17.x              | Pixel / iPhone                                                                | Pass  |         |      | **Mobile portrait** (Pixel 7 / iPhone 14) |
| TC018     | Chrome (Android), Safari (iOS)       | Chrome 139.0.7258.128 · Safari 17.x | Pixel / iPhone                                                                | Pass   |         |      | **Mobile landscape** spot checks |
| TC019     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                           | Pass   |         |      | Keyboard navigation (Tab/Shift+Tab/Enter) |
| TC020     | Safari (macOS/iOS), Chrome, Edge     | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · Safari 17.x | 〃                                                                             | Pass   |         |      | Screen reader basics (VoiceOver/NVDA quick pass) |
| TC021     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                             | Pass   |         |      | Semantic HTML (landmarks, heading order) |
| TC022     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x | Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            | Pass   |         |      | Alt text: informative vs decorative (icons alt="") |
| TC023     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x | Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                             | Pass   |         |      | ARIA use (carousel, live regions if any) |
| TC024     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            |    |         |  Fail    | “Skip to content” works; anchor offset OK |No visible “Skip to content” link appears as the first focusable element on page load on the reviewed pages. I also don’t see markup for a skip link targeting
Suggestions
Fix (minimal, accessible pattern).
| TC025     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            | Pass   |         |      | (Use this for any performance or extra feature test) |
| TC026     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            | Pass   |         |      | Images optimised (WebP / sizes) |
| TC027     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x| Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                            | Pass   |         |      | HTML/CSS validation (W3C) — no critical errors |
| TC028     | Chrome, Edge, Firefox, Safari        | Chrome 139.0.7258.128 · Edge 139.0.3405.102 · FF 142.0 · Safari 17.x | Mobile/Tablet/Laptop/Desktop: iPhone SE, iPad Air, Nest Hub & Nest Hub Max                                                                             | Pass   |         |      | Regression sweep after updates — no breaks |
